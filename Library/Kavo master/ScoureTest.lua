...
function Kavo.CreateLib(params)
    if not params.themeList then
        themeList = themes
    end
    ...
    local Avatar2 = Instance.new("Frame")
    ...
    local Icon = Instance.new("ImageLabel")
    local InfoDiscord = Instance.new("Frame")
    ...
    Avatar2.Size = UDim2.new(0, 30, 0, 30)
    Avatar2.Position = UDim2.new(0, 3, 0, 0)
    Avatar2.BackgroundColor3 = themeList.Header
    Objects[MainHeader] = "BackgroundColor3"
    Avatar2.Image = pfp
    Avatar2.ImageTransparency = 0.5
...
NamePlayer.BackgroundColor3 = Color3.new(0, 0, 0)
...
InfoPlayer.Position = UDim2.new(0.16, 0, 0.1, 0)
InfoPlayer.BackgroundColor3 = Color3.new(0, 0, 0)
InfoPlayer.BorderSizePixel = 0
InfoPlayer.Text = "Active"
...
Discord.Position = UDim2.new(0.800000012, 0, 0.0599999987, 0)
Discord.BackgroundColor3 = Color3.fromRGB(114, 137, 218)
Discord.Text = ""
Discord.Parent = SettingsFrame

Icon.Size = UDim2.new(0.609999955, 0, 1, 0)
Icon.Position = UDim2.new(0.200000003, 0, 0, 0)
Icon.ImageColor3 = Color3.new(1, 1, 1)
Icon.Image = "rbxthumb://type=Asset&id=124135407373085&w=420&h=420"
Icon.BackgroundTransparency = 1
Icon.Active = false
Icon.Parent = Discord
...
Corner2.Parent = Discord

InfoDiscord.Size = UDim2.new(0.980000019, 0, 0.499999821, 0)
InfoDiscord.Position = UDim2.new(0.0100000026, 0, 0.469999999, 0)
...
InfoDiscord.Parent = gui
	...
	MainSide.tabFrames = true
        ...
        Tabline.Size = UDim2.new(0, 27, 0, 27)
        Tabline.Position = UDim2.new(0, 7, 0, 20)
        ...
        coroutine.wrap(function()
            ...
            function Elements:NewLabel(title)
		        ...
		        coroutine.wrap(function()
		            while wait() do
		                label.BackgroundColor3 = themeList.SchemeColor
		                label.TextColo3 = themeList.TextColor
		            end
		        end)()
                updateSectionFrame()
                UpdateSize()
