	...
	["Việt Nam"] = {
		["Rainbow Friends"] = {
			...
			["Main 1"] = {
				...
				["Teleport Build Structures"] = "Dịch chuyển đến Structures"
			},
			["Main 2"] = {
				["Esp"] = "Định vị",
		...
		["Ink Game"] = {
			...
			["Main"] = {
				...
				["Tug Of War / Hide & Seek"] = "Kéo co / trốn tìm",
				["Auto Tug of War"] = "Auto Kéo",
				["Esp Door Exit"] = "Định vị cứu thoát",
				["Esp Key"] = "Định vị chìa khóa",
				...
				["Complete Glass Bridge"] = "Hoàn thành cầu kính",

				["Mingle"] = "Giao lưu",
				["Auto Mingle"] = "Auto bẻ cổ",

				["Rebel"] = "Kẻ nổi loạn",
				["WallCheck"] = "Kiểm tra tường",
				["Aimbot Guard"] = "Nhắm mục tiêu Guard",
				["Bring Guard"] = "Mang Guard",
				["Inf Ammo"] = "Vô cực đạn"
			},
			["Misc"] = {
				["Auto Skip"] = "Auto Bỏ qua",
				["Speed"] = "Tốc độ",
				["Auto Speed"] = "Auto đặt tốc độ",
				["No Cooldown Proximity"] = "Ko hồi chiều Proximity",
				["Noclip"] = "Xuyên tường",
